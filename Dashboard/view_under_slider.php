                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="view_under_slider.php" class="dropdown-item active mb-1">View All</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">View Under Slider</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <img src="Upload/<?php echo htmlspecialchars($row['img_under1']) ; ?>" title="<?php echo htmlspecialchars($row['img_under1']) ; ?>" style="width: 55px ; height:55px ;"> 
                                            </td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['title_under1']) ; ?></td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['description_under1']) ; ?></td>
                                            <td>
                                                <img src="Upload/<?php echo htmlspecialchars($row['img_under2']) ; ?>" title="<?php echo htmlspecialchars($row['img_under2']) ; ?>" style="width: 55px ; height:55px ;"> 
                                            </td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['title_under2']) ; ?></td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['description_under2']) ; ?></td>
                                            <td>
                                                <img src="Upload/<?php echo htmlspecialchars($row['img_under3']) ; ?>" title="<?php echo htmlspecialchars($row['img_under3']) ; ?>" style="width: 55px ; height:55px ;"> 
                                            </td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['title_under3']) ; ?></td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['description_under3']) ; ?></td>
                                            <td style="padding-top: 23px;">
                                                <a href="add_under_slider.php?edit_under=<?php echo $row['id_under']; ?>" ><i class="fa fa-edit" title="edit"></i></a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
