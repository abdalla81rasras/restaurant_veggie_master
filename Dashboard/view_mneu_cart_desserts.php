                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="view_mneu_cart_desserts.php" class="dropdown-item active mb-1">View All</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">View Mneu Cart Desserts</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded table-responsive cust-secroll h-100 p-3">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        $select="SELECT * FROM `mneu_cart_desserts`";
                                        $query=mysqli_query($conn , $select);
                                        while($row=mysqli_fetch_assoc($query)):
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($row['name_recipe_desserts']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['content_recipe_desserts']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['price_recipe_desserts']) ; ?>$</td>
                                            <td>
                                                <a href="add_mneu_cart_desserts.php?edit_desserts=<?php echo $row['id_cart_desserts']; ?>" ><i class="fa fa-edit" title="edit"></i></a> |   
                                                <a href="add_mneu_cart_desserts.php?delete_desserts=<?php echo $row['id_cart_desserts']; ?>" ><i class="fa fa-trash" title="delete"></i></a>
                                            </td>
                                        </tr>
                                    <?php endwhile;  ?>
                                </tbody>
