                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="form_conact.php" class="dropdown-item active">Form Contact</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">Form Contact</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($row['message_form']) ; ?></td>
                                            <td>
                                                <a href="add_contact.php?delete_form=<?php echo $row['id_form']; ?>" ><i class="fa fa-trash" title="delete"></i></a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>    
                                </tbody>
