                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="view_footer.php" class="dropdown-item active">View All</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">View Footer</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                        ...
                        <div class="bg-secondary rounded table-responsive cust-secroll h-100 p-3">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($row['facebook_footer']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['instagram_footer']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['twitter_footer']) ; ?></td>
                                            <td>
