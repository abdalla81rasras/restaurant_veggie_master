                ...
                <div class="navbar-nav nv w-100">
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="view_header.php" class="dropdown-item active">View all</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">View Header</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <img src="Upload/<?php echo htmlspecialchars($row['img_tab']) ; ?>" title="<?php echo htmlspecialchars($row['img_tab']) ; ?>" style="width: 55px ; height:55px ;"> 
                                            </td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['title_tab']) ; ?></td>
                                            <td style="padding-top: 23px;">
                                                <a href="add_header.php?edit_header=<?php echo $row['id_header']; ?>" class="mx-auto"><i class="fa fa-edit" title="edit"></i></a>   
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
