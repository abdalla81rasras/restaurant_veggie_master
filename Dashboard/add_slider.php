...
?>
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa me-2"><span style="font-size: 24px;">S</span></i>Slider</a>
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            <a href="add_slider.php" class="dropdown-item avtive mb-1">Add New</a>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6 col-xl-6">
                            <h3 class="text-secondary alert-link">Add Slider</h3>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="bg-secondary rounded align-items-center justify-content-between p-3">
                                <div class="input-group custom-file-button">
                                    <label class="input-group-text form-control-lg alert-link text-secondary" for="inputFileSlider">Image Slider</label>
                                    <input type="file" name="img_slider" accept="Image/*" class="form-control text-primary form-control-lg bg-dark" id="inputFileSlider">
                                </div>
                                <div class="text-danger mt-1"><?php echo $errors['img_slider'] ?></div>
                                <?php if($edit==true): ?>
                                    <div class="text-warning my-2"><?php echo $errors['edit_img_slider'] ?></div>
                                    <p class="text-primary font-weight-bold mr-2 d-inline">Old Image :  </p>
                                    <img src="Upload/<?php echo $img_slider ?>" title="<?php echo $img_slider ?>" alt="Image" style="width:100px; height: 100px;">
                                <?php endif; ?> 
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="bg-secondary rounded align-items-center justify-content-between p-3">
                                <div class="form-floating">
                                    <input type="text" name="title_slider" class="form-control" value="<?php echo htmlspecialchars($title_slider); ?>" id="floatingInputTilte" placeholder=" ">
                                    <label for="floatingInputTilte">Title Slider</label>
                                    <div class="text-danger mt-1"><?php echo $errors['title_slider'] ?></div>
                                </div>                             
                            </div>
                        </div>
                    </div>
                    <div class="row g-4 justify-content-around mt-2 mb-3">
                        <div class="col-lg-2 col-xl-2">
                            <?php if($update==true): ?>
                                <button name="update_slider" class="btn btn-secondary m-2 w-100 h-100 alert-link">Update</button>
                            <?php else: ?>
                                <button name="save_slider" class="btn btn-secondary m-2 w-100 h-100 alert-link">Save</button>
                            <?php endif; ?>
                        </div>
                        <div class="col-lg-2 col-xl-2">
                            <button name="cansel_slider" class="btn btn-secondary m-2 w-100 h-100 alert-link">Cansel</button>
                        </div>
                    </div>
                </form> <br>
            </div>
