...
?>
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa me-2"><span style="font-size: 24px;">A</span></i>About Us</a>
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            <a href="add_about.php" class="dropdown-item mb-1">Add New</a>
                            <a href="view_about.php" class="dropdown-item active mb-1">View All</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">View About Us</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <img src="Upload/<?php echo htmlspecialchars($row['img_about']) ; ?>" title="<?php echo htmlspecialchars($row['img_about']) ; ?>" style="width: 55px ; height:55px ; cursor: pointer;"> 
                                            </td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['title_about']) ; ?></td>
                                            <td style="padding-top: 23px;"><?php echo htmlspecialchars($row['description_about']) ; ?></td>
