                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="view_contact.php" class="dropdown-item active mb-1">View All</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="col-sm-6 col-xl-6">
                            <h3 class="text-secondary alert-link">Show Contact</h3>
                        </div>
                    </div>
                <div class="row mt-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlspecialchars($row['address_contact']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['phonen_contact']) ; ?></td>
                                            <td>
