                ...
                <div class="navbar-nav nv w-100">
                    ...
                    <div class="nav-item dropdown mb-3">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 mx-4 mt-0">
                            ...
                            <a href="view_mneu_cart_main.php" class="dropdown-item active mb-1">View All</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown mb-3">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded table-responsive cust-secroll h-100 p-3">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php 
                                       $select="SELECT * FROM `mneu_cart_main`";
                                       $query=mysqli_query($conn , $select);
                                       while($row=mysqli_fetch_assoc($query)): 
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($row['name_recipe_main']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['content_recipe_main']) ; ?></td>
                                            <td><?php echo htmlspecialchars($row['price_recipe_main']) ; ?></td>
                                            <td>
                                                <a href="add_mneu_cart_main.php?edit_main=<?php echo $row['id_cart_main']; ?>" ><i class="fa fa-edit" title="edit"></i></a> |   
                                                <a href="add_mneu_cart_main.php?delete_main=<?php echo $row['id_cart_main']; ?>" ><i class="fa fa-trash" title="delete"></i></a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                </tbody>
